...
import { fetchPhotosApi, createPhotoApi, updatePhotoApi, deletePhotoApi } from "@/services/api";
...
describe("PhotosPage Create", () => {
    const initialPhotos = [
        { id: 1, title: "Sunset", photo_category: "Nature", camera_brand: "Canon", gear_used: "Tripod", photo_taken: new Date().toISOString(), photo_path: "" },
        { id: 2, title: "Beach", photo_category: "Travel", camera_brand: "Sony", gear_used: "Drone", photo_taken: new Date().toISOString(), photo_path: "" },
    ];
    ...
    it("Create a new photo", async () => {
        ...
        (createPhotoApi as Mock).mockResolvedValue({ success: true, data: newPhoto });
        ...
        (fetchPhotosApi as Mock).mockResolvedValueOnce([...initialPhotos, newPhoto]);
        render(<PhotosPage />);
        ...
        await waitFor(() => {
            ...
            const img = screen.getByAltText("Photo titled Mountain") as HTMLImageElement;
