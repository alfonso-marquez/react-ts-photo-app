...
export default function DeletePhotoDialog({ photo, setPhotos }: DeletePhotoDialogProps) {
    ...
    return (<Dialog>
        <DialogTrigger asChild><Button variant="outline" > <Trash color="#f35353" /></Button></DialogTrigger>
        <DialogContent>
            <DialogHeader>
                <DialogTitle>Are you sure you want to delete?</DialogTitle>
                <DialogDescription>
                    This action cannot be undone. It will permanently delete the photo from the list.
                </DialogDescription>
            </DialogHeader>
