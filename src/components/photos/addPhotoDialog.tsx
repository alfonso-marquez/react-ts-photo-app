  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      if (error instanceof Error) {
        setApiError(
          error.message || "An error occurred while creating the photo",
        );
      } else {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button className="bg-green-500 hover:bg-green-600 p-5">
          <Upload />
          Photo
        </Button>
      </DialogTrigger>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Gears/Accessories used.</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
